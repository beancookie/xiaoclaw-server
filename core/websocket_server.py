...
class WebSocketServer:
    def __init__(self, config: dict):
        ...
        modules = initialize_modules(
            ...
            "LLM" in self.config["selected_module"] and self.config["server"].get("enable_server_llm", True),
            False,
        ...
        try:
            async with self.config_lock:
                ...
                modules = initialize_modules(
                    ...
                    update_vad,
                    update_asr,
                    "LLM" in new_config["selected_module"] and new_config["server"].get("enable_server_llm", True),
                    False,
